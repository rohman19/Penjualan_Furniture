 ...
 * @author user
 */
public class Aplikasi_Data_Member_Kirim extends javax.swing.JDialog {
koneksi kon=new koneksi();
public Aplikasi_Transaksi transaksi = null;
public Aplikasi_Barang_Keluar pesan = null;
...
private String[]label={"Kode Member","Nama Member","Alamat","Kota","No Telepon"};
     ...
     */
   public Aplikasi_Data_Member_Kirim(java.awt.Frame parent, boolean modal) {
       super(parent, modal);
        initComponents();
 ...
 private void BacaTabelMember2(){
    ...
    private void tbl_brgMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_brgMouseClicked
        ...
        pesan.NamaMember = tbl_brg.getValueAt(tabelBarang, 1). toString();
         pesan.Alamat = tbl_brg.getValueAt(tabelBarang, 2). toString();
            pesan.Kota = tbl_brg.getValueAt(tabelBarang, 3). toString();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Aplikasi_Data_Member_Kirim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Aplikasi_Data_Member_Kirim dialog = new Aplikasi_Data_Member_Kirim(new javax.swing.JFrame(), true);
