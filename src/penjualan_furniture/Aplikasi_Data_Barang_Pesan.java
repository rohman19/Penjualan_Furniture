 ...
 * @author user
 */
public class Aplikasi_Data_Barang_Pesan extends javax.swing.JDialog {
...
private String[]label={"Kode Barang","Nama Barang","Deskripsi","Harga Barang","Stok"};
     ...
     */
   public Aplikasi_Data_Barang_Pesan(java.awt.Frame parent, boolean modal) {
       super(parent, modal);
        initComponents();
 ...
 private void BacaTabelBarang2(){
    ...
    private void initComponents() {
        ...
        setTitle("Aplikasi Data Barang Pesan\n\n");
    ...
    private void tbl_brgMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_brgMouseClicked
     ...
     pesan.KodeBarang = tbl_brg.getValueAt(tabelBarang, 0).toString();
        pesan.NamaBarang = tbl_brg.getValueAt(tabelBarang, 1).toString();
         pesan.Deskripsi = tbl_brg.getValueAt(tabelBarang, 2).toString();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Aplikasi_Data_Barang_Pesan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Aplikasi_Data_Barang_Pesan dialog = new Aplikasi_Data_Barang_Pesan(new javax.swing.JFrame(), true);
