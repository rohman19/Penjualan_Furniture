 ...
 * @author user
 */
public class Aplikasi_Data_Pengiriman extends javax.swing.JDialog {
...
private String[]label={"Kode Barang","Nama Barang","Deskripsi","Harga Barang","Stok"};
     ...
     */
   public Aplikasi_Data_Pengiriman(java.awt.Frame parent, boolean modal) {
       super(parent, modal);
        initComponents();
 ...
 private void BacaTabelBarang2(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Aplikasi_Data_Pengiriman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Aplikasi_Data_Pengiriman dialog = new Aplikasi_Data_Pengiriman(new javax.swing.JFrame(), true);
