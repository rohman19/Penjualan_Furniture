 ...
 * @author user
 */
public class Aplikasi_Data_Member extends javax.swing.JDialog {
...
private String[]label={"Kode Member","Nama Member","Alamat","Kota","No Telepon"};
    /**
     * Creates new form Aplikasi_Data_Member
     */
   public Aplikasi_Data_Member(java.awt.Frame parent, boolean modal) {
       super(parent, modal);
        initComponents();
     ...
     private void BacaTabelMember(){
        try{
            ...
            tbl_brg.setModel(new DefaultTableModel(datamember,label));
        }
        catch(SQLException e){
            JOptionPane.showMessageDialog(null, e);
        }
    }
 private void BacaTabelMember2(){
        try{
            String sql="select *from member where nm_member like '%" +tcari.getText()+ "%' ";
            kon.rs=kon.st.executeQuery(sql);
             ResultSetMetaData m=kon.rs.getMetaData();
            int kolom=m.getColumnCount();
            int baris=0;
    ...
    private void tbl_brgMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_brgMouseClicked
        ...
        transaksi.HargaBarang = tbl_brg.getValueAt(tabelBarang, 2).toString();
        transaksi.KodeMember = tbl_brg.getValueAt(tabelBarang, 0). toString();
        transaksi.NamaMember = tbl_brg.getValueAt(tabelBarang, 1). toString();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Aplikasi_Data_Member.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Aplikasi_Data_Member dialog = new Aplikasi_Data_Member(new javax.swing.JFrame(), true);
