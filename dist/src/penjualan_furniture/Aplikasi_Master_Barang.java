 ...
 * @author user
 */
public class Aplikasi_Master_Barang extends javax.swing.JInternalFrame {
koneksi kon =new koneksi();
private Object[][] databarang=null;
private String[] label={"Kode Barang","Nama Barang","Deskripsi Barang","Harga Jual","Stok"};
    /**
   ...
   public Aplikasi_Master_Barang() {
    ...
    private void SetTabel()
    {
        ...
        tdes.setText((String)tbl_brg.getValueAt(row, 2));
        thrg_jual.setText((String)tbl_brg.getValueAt(row, 3));
        tstok.setText((String)tbl_brg.getValueAt(row, 4));
    }
    private void Bersih()
    {
        tkd_brg.setText("");
    ...
    private void SimpanData()
    {
        try{
            String sql="insert into barang values('"+tkd_brg.getText()+"',"
                    +"'"+tnm_brg.getText()+"','"+tdes.getText()+"',"
                    +"'"+thrg_jual.getText()+"','"+tstok.getText()+"')";
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Aplikasi_Master_Barang\n");
    ...
    private void bt_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_simpanActionPerformed
        ...
        }else if (tnm_brg.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Lengkapi Data Nama Barang", "Konfirmasi", JOptionPane.INFORMATION_MESSAGE);
            bt_tambah.setEnabled(true);
            }else if (tdes.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Lengkapi Data Deskripsi", "Konfirmasi", JOptionPane.INFORMATION_MESSAGE);
            bt_tambah.setEnabled(true);
            }else if (thrg_jual.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Lengkapi Data Harga", "Konfirmasi", JOptionPane.INFORMATION_MESSAGE);
            bt_tambah.setEnabled(true);
            }else if (tstok.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Stok Masih Kosong", "Konfirmasi", JOptionPane.INFORMATION_MESSAGE);
            bt_tambah.setEnabled(true);
